...
# save precision, recall, f1-score, and accuracy
df_metrics = pd.DataFrame(classification_report(labels, fused_preds, output_dict=True)).transpose()
df_metrics.to_csv('E:/master-2/madgewick_filter/testing_model/metrics.csv', index=True)
