...
data_root = 'E:/master-2/madgewick_filter/train_data/IMU'
...
# output_csv_path = 'E:/master-2/madgewick_filter/train_data/output_imu_data_info.csv'
...
print(f'Data and labels info saved to {output_csv_path2} ')
